...
export const TYPES = mapValues(
  {
    ...
    DS_ATHENA: ["/data-sources/amazon-athena", "Guide: Help Setting up Amazon Athena"],
    ...
    DS_GOOGLE_SPREADSHEETS: ["/data-sources/google-sheets", "Guide: Help Setting up Google Spreadsheets"],
    DS_GOOGLE_ANALYTICS: ["/data-sources/google-analytics", "Guide: Help Setting up Google Analytics"],
