...
describe("SvgIcon", () => {
  it("adds the correct class", () => {
    ...
    expect(ReactDOM.renderToStaticMarkup(<SvgIcon svg={svg} />)).to
      .equal(`<svg class="svg-icon " viewBox="0 0 10 8" preserveAspectRatio="xMidYMid meet"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <path d="M5.00000013,3.79318225 L1.92954627,0.341495392 L0.247423305,1.81335299 L5,7.24486921 Z"></path>
    </g>
</svg>`);
