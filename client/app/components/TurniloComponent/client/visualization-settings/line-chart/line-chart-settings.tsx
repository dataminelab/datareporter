...
export const LineChartSettingsComponent: VisualizationSettingsComponent<LineChartSettings> = ({
  settings,
  onChange,
}) => {
  ...
  return (
    <div className="settings-row">
      <Checkbox selected={settings.groupSeries} label="Group series" onClick={toggleGroupSeries} />
    </div>
  );
};
