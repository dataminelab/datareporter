...
export const CUSTOMIZATION = {
  ...
  urlShortener: {
    label: "Url Shortener",
    description:
      "Code for request call to url shortener service. If provided, additional options would show in share menu.",
  },
  externalViews: {
...
export const CLUSTER = {
  ...
  version: {
    label: "Version",
    description:
      "The explicit version to use for this cluster. This does not need to be defined " +
...
export const GENERAL = {
  "customization.title": {
    label: "Title",
    description:
      "What will appear as the tab's title in your browser. Use <code>%v</code> as a placeholder for Turnilo's version.",
  },
