...
export const quantile = measure(
  "quantile",
  $("main").quantile($("histogram"), 0.95, "tuning"),
);
export const complex = measure(
  "complex",
  $("main").sum($("a")).divide($("b").multiply(100)),
);
...
export function measure(
  ...
  opts: Omit<MeasureValue, "name" | "formula"> = {},
) {
  return new Measure({
    name,
