    ...
    <div className="admin-page-layout">
      <div className="container">
        ...
        <div className="bg-white tiled">
          <Tabs
            className="admin-page-layout-tabs"
          ...
          >
            <Tabs.TabPane
              key="system_status"
              tab={<a href="admin/status">System Status</a>}
            >
              {activeTab === "system_status" ? children : null}
            </Tabs.TabPane>
            <Tabs.TabPane
              key="jobs"
              tab={<a href="admin/queries/jobs">RQ Status</a>}
            >
              {activeTab === "jobs" ? children : null}
            </Tabs.TabPane>
            <Tabs.TabPane
              key="outdated_queries"
              tab={<a href="admin/queries/outdated">Outdated Queries</a>}
            >
