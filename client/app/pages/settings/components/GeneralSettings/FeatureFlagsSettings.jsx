        ...
        {loading ? (
          <>
            <Row>
              <Skeleton
                title={false}
                paragraph={{ width: [300, 300, 300], rows: 3 }}
                active
              />
            </Row>
          </>
          ...
          <>
            <DynamicComponent
              name="OrganizationSettings.FeatureFlagsSettings.PermissionsControl"
              {...props}
            >
              <Row>
                <Checkbox
                  ...
                  onChange={e =>
                    onChange({
                      feature_show_permissions_control: e.target.checked,
                    })
                  }
                >
            ...
            <Row>
              <Checkbox
                ...
                onChange={e =>
                  onChange({
                    send_email_on_failed_scheduled_queries: e.target.checked,
                  })
                }
              >
            ...
            <Row>
              ...
              >
                Enable multi-byte (Chinese, Japanese, and Korean) search for
                query names and descriptions (slower)
              </Checkbox>
            </Row>
          </>
        )}
