...
Plywood consists of three logical parts: an expression language for describing data queries, a set of _externals_ for
...
Plywood's language (called _plywood_, with a lowercase "P") is heavily inspired by
