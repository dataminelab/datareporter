...
class ModelsConfigResource(BaseResource):
    ...
    def post(self, model_id):
        ...
        self.record_event({"action": action, "object_id": config.id, "object_type": "model_config"})
...
class ModelsConfigGetResource(BaseResource):
    ...
    def get(self, config_id):
        ...
        self.record_event({"action": "view", "object_id": config.id, "object_type": "model_config"})
