You can use this folder to add scripts and configurations to customize DataReporter build and development loop.
...
- **staticPath**: Override the location of DataReporter static files (default = `/static/`).
