...
class TestModelsConfigCreateResource(BaseTestCase):
    ...
    def test_user_without_model_permission(self):
        ...
        response = self.make_request("post", "/api/models/1/config", data={"content": "dataCube: 12"}, user=user)
    ...
    def test_content_length_greater_than_20000(self):
        ...
        response = self.make_request("post", "/api/models/100/config", data={"content": content}, user=user)
    ...
    def test_not_valid_content(self):
        ...
        response = self.make_request(
            "post", "/api/models/100/config", data={"content": "dataCube: 12\n key: 1"}, user=user
        )
