        ...
        "query_result": {
            ...
            "data": {
                "columns": [
                    ...
                    {"name": "_previous__active", "friendly_name": "_previous__active", "type": "integer"},
                    {"name": "_delta__active", "friendly_name": "_delta__active", "type": "integer"},
                ],
                "rows": [{"active": 584, "_previous__active": 584, "_delta__active": 0}],
            },
            "data_source_id": 1,
...
POSTGRES_0_SPLIT_SHAPE_TIMESHIFT = {
    "attributes": [
        ...
        {"name": "_previous__active", "type": "NUMBER"},
        {"name": "_delta__active", "type": "NUMBER"},
    ],
    "data": [{"MillisecondsInInterval": 86400000, "active": 4, "_previous__active": 4, "_delta__active": 4}],
}
...
POSTGRES_0_SPLIT_RESULT_TIMESHIFT = {
    ...
    "data": [{"MillisecondsInInterval": 86400000, "active": 584, "_previous__active": 584, "_delta__active": 0}],
}
